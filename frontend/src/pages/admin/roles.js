...
export const ROLE_TABS = {
  admin: ['dashboard', 'actualites', 'enfants', 'finances', 'evaluation', 'donateurs', 'messages', 'volunteers', 'testimonials', 'comptes'],
  president: ['dashboard', 'actualites', 'messages', 'volunteers', 'testimonials'],
